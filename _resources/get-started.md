...
details: Start here for an an introduction to major concepts and an overview of how inaccuracies can be introduced into datasets.
...
### Overview
Data can contain systemic inaccuracies. These inaccuracies can arise in every step of the decision-making process--for data driven decisions, the process by which you collect and treat data may introduce inaccurate data. The decision-making frameworks themselves, often driven by artificial intelligence or machine learning algorithms, can also be constructed in a way that introduces imprecise and innacurate data. The effects of imprecise data can take many forms; for example, a group may be less likely to receive resources that it otherwise should be allocated--think jobs, government benefits, and housing, among other things.

This toolkit is designed to help you identify, understand, and mitigate potential sources of inaccuracies in your data, algorithms, and processes. This toolkit is targeted towards practitioners and managers with intermediate knowledge of data collection and AI/ML algorithms. The resources featured here are relevant to both technical teams and teams whose mission could be impacted by certain tools, i.e. hiring managers seeking to build a more transparent hiring process.

Below is a list of introductory terms that are related to data inaccuracies found in artificial intelligence (AI) and machine learning (ML) applications.
